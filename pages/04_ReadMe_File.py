...
def readme_page():
    ...
    ├── llm_theory.py     # LLM Theory and visualization page
    ├── practical.py      # Practical PDF Q&A page using LLaMA
    ├── helper.py         # Helper page with eBooks and links
    ...
    - **Main:** Overview and workshop introduction.
